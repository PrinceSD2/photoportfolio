...
const categoryData: Record<string, {
  ...
  images: [
    ...
    '/images/photography/food/b10.jpg',
    '/images/photography/food/b11.jpg',
    '/images/photography/food/thumb.jpg',
  ]
},
 model: {
    ...
    images: [
      ...
      '/images/photography/model/f11.jpg',
      '/images/photography/model/thumb.jpg',
  ],
  },
  hotel: {
   ...
   '/images/photography/hotel/h1.jpg',
    ...
    '/images/photography/hotel/h16.jpg',  
    '/images/photography/hotel/h17.jpg',  
    '/images/photography/hotel/h18.jpg',  
    '/images/photography/hotel/h19.jpg',  
    '/images/photography/hotel/f4.jpg',  
    '/images/photography/hotel/thumb.jpg',  
  ],
},
  Interior: {
  name: 'Interior ',
  ...
  images: [
    ...
    '/images/photography/office/o8.jpg', // <-- Use o8.jpg as thumb
    '/images/photography/office/o9.jpg',
    '/images/photography/office/o11.jpg',
    '/images/photography/office/o12.jpg',
    '/images/photography/office/o13.jpg',
    '/images/photography/office/o14.jpg',
    '/images/photography/office/o15.jpg',
    '/images/photography/office/thumb.jpg', // <-- Add as thumb image at the end
  ],
},
      Product: {
                  ...
                  >
                    <div className="relative aspect-[4/5] overflow-hidden rounded-lg mb-3">
                      <Image
                        src={
                          slug === "Interior"
                            ? "/images/photography/office/thumb.jpg" // <-- Use thumb.jpg for Interior
                            : `/images/photography/${slug}/thumb.jpg`
                        }
                        alt={data.name}
                        fill
